...
apt-get -y -qq install filezilla filezilla-common || echo -e ' '${RED}'[!] Issue with apt-get'${RESET}
#--- Configure filezilla
export DISPLAY=:0.0   #[[ -z $SSH_CONNECTION ]] || export DISPLAY=:0.0
...
##### Install nmap script & parser
echo -e "\n ${GREEN}[+]${RESET} Downloading ${GREEN}banner-plus.nse${RESET} ~ NMAP Script and Parser"
gem install nmap-parser
curl --progress -k -L -f "https://raw.github.com/hdm/scan-tools/master/nse/banner-plus.nse" > /usr/share/nmap/scripts/banner-plus.nse || echo -e ' '${RED}'[!]'${RESET}" Issue downloading banner-plus.nse" 1>&2          #***!!! hardcoded path!
...
apt-get -y -qq install ldap-utils || echo -e ' '${RED}'[!] Issue with apt-get'${RESET}
#--- Create samba user
